//
//  BBImageScaleController.m
//  NavigationControllerPractice
//
//  Created by BiaoGe on 2016/12/6.
//  Copyright © 2016年 BiaoGe. All rights reserved.
//

#import "BBImageScaleController.h"

@interface BBImageScaleController ()
@property (nonatomic,weak)UIView *headerView;
@property (nonatomic,weak)UIImageView *headImageView;

@end

@implementation BBImageScaleController
-(void)setupUI{
...
-(void)settingHeaderView{
    UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 0, BBHeaderImageH-15)];
...
-(void)settingHeaderBackgroundView{
    UIImageView *headImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ScreenW, BBHeaderImageH)];
    headImageView.contentMode = UIViewContentModeScaleAspectFill;
    headImageView.image = [UIImage imageNamed:@"6.jpg"];
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (offsetY > 0) {
        ...
        tempF.size.height = BBHeaderImageH - offsetY;
        tempF.origin.y = 0;
        self.headImageView.frame = tempF;
    }
